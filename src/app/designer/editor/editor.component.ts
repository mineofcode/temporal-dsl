...
import { RouteStepComponent } from '../../designer/custom-step/route-step/route-step.component';
...
export class EditorComponent implements OnInit {
    ...
    constructor(
        ...
        this.customOps = this.dataService.customOps;
        nodeCommService.events.subscribe((d) => {
            if (d?.data?.name) {
                console.log(d);
                let object = undefined;
                // for (let k = 0; k < this.customOps.length; k++) {
                //     const el = this.customOps[k];
                //     if (el.type == d.type) {
                //         object = el.data;
                //         break;
                //     }
                //     if (el?.data?.subdata) {
                //         if (el?.data?.subdata.type == d?.data?.type) {
                //             object = el.data.subdata;
                //             break;
                //         }
                //     }
                ...
                // if (object) {
                //     this.drawerData = object; // Object.assign(d.data, object);
                // } else {
                //     this.drawerData = [];
    ...
    drawerUpdateHandle() {
        this.dataService.updateDrawer(this.drawerData);
    }
